...
public class DBHelper2 extends SQLiteOpenHelper {
    ...
    public static final String database_name = "db_finalproject";
    public static final String tabel_name = "table_buku";

    public static final String row_id = "_id";
    public static final String row_judul = "Judul";
    public static final String row_pengarang = "Pengarang";
    public static final String row_penerbit = "Penerbit";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String query = "CREATE TABLE "+ tabel_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_judul + " TEXT, " + row_pengarang + " TEXT, " + row_penerbit + " TEXT, " + row_genre + " TEXT, " + row_status + " TEXT) ";
        db.execSQL(query);
    }
